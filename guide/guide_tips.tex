...
\begin{itemize}
  ...
  \item \Macro{numerrt}, \Macro{numpmerr} and \Macro{numpmerrt}
...
\end{equation*}
\end{tcblisting}
% The first example is in text mode, while the second is in math mode.
% As you can see the macros work in both modes.\footnote{%
% If you compile the guide with \LuaLaTeX\ or \XeLaTeX\
% the superscripts and subscripts are not rendered correctly,
% neither in the listing nor in normal text, e.g.\ \numpmerr{+0.123}{-0.456}.
% The reason for this in being investigated.}
