...
\DeclareSIUnit\clight{\ensuremath{\mathit{c}}} % siunitx verson 3 (after 2021/04/09)
\end{tcblisting}
...
If you have two errors then use \Macro{qtyerrtt}
...
\Macro{qtypmerrs}. Examples of their use are:
\begin{tcblisting}{}
\begin{align*}
