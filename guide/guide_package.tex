...
as a language in your thesis or to edit the \File{.lof} and \File{.lot} files by adding a line:
`\babel@toc {english}{}\relax` after other such lines.
This is not a nice option, as you have to do this every time the \File{.lof} or \File{.lot} files change,
