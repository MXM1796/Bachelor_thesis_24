...
\newcommand*{\guideversion}{10.0}
\newcommand*{\TweakYear}{2020}

\usepackage{ifthen}

% diffcoeff package released in 2016 - define a simple form of \diff for earlier.
\ifthenelse{\TweakYear < 2016}{%
  \newcommand*{\diffcoeff}{diffcoeff=false}
...
\newcommand*{\thesissubmit}{XX.YY.2022}
% \newcommand*{\thesissubmit}{Month 2022}
% Date of thesis examination (PhD)
\newcommand*{\thesispromotion}{XX.YY.2022}
% Month and year of the final printed version of the thesis
\newcommand*{\thesismonth}{January}
\newcommand*{\thesisyear}{2022}
\newcommand*{\thesisnumber}{BONN-IR-2022-XXX}
